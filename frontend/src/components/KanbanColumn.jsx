...
// isTeacherView prop ni add chesam
  ...
  return (
    <div className="w-[320px] flex-shrink-0 flex flex-col h-full max-h-full">
      ...
      <div className="flex items-center justify-between px-3 mb-4">
        ...
        <span className="bg-slate-200/50 text-slate-600 text-[11px] px-2.5 py-1 rounded-full font-bold">
          {tasks?.length}
        </span>
      </div>
          ...
          <div
            ...
            className={`flex-1 overflow-y-auto no-scrollbar rounded-[2rem] p-3 transition-all duration-300 ${
              snapshot.isDraggingOver 
                ? 'bg-indigo-50/80 ring-2 ring-indigo-200 ring-dashed' 
